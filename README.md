...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6ke5vac.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6ke5vac.containers.anotherwebservice.com/
...
```
git clone git@github.com:nobodyspecial/container-6ke5vac.git
cd container-6ke5vac
```
...
```
docker attach container-6ke5vac
```
